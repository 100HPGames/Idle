...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticPatterns
    {
        ...
        /// </summary>
        internal static Preset Selection => HapticVariablesManager.Selection;

        /// <summary>
        /// Predefined Preset that represents a "Light" haptic preset
        /// </summary>
        internal static Preset Light => HapticVariablesManager.Light;

        /// <summary>
        /// Predefined Preset that represents a "Medium" haptic preset
        /// </summary>
        internal static Preset Medium => HapticVariablesManager.Medium;

        /// <summary>
        /// Predefined Preset that represents a "Heavy" haptic preset
        /// </summary>
        internal static Preset Heavy => HapticVariablesManager.Heavy;

        /// <summary>
        /// Predefined Preset that represents a "Rigid" haptic preset
        /// </summary>
        internal static Preset Rigid => HapticVariablesManager.Rigid;

        /// <summary>
        /// Predefined Preset that represents a "Soft" haptic preset
        /// </summary>
        internal static Preset Soft => HapticVariablesManager.Soft;

        /// <summary>
        /// Predefined Preset that represents a "Success" haptic preset
        /// </summary>
        internal static Preset Success => HapticVariablesManager.Success;

        /// <summary>
        /// Predefined Preset that represents a "Failure" haptic preset
        /// </summary>
        internal static Preset Failure => HapticVariablesManager.Failure;

        /// <summary>
        /// Predefined Preset that represents a "Warning" haptic preset
        /// </summary>
        internal static Preset Warning => HapticVariablesManager.Warning;
