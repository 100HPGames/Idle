...
namespace CodeBase.Tools.Helpers
{
    public static class WowExtensions
    {
        ...
        public static void FadeText(this TextMeshProUGUI text, float value, float duration)
            => text.DOFade(value, duration)
                .SetUpdate(true)
                .SetLink(text.gameObject);

        public static void BounceLoop(this Transform value, float duration, float bounceValue)
            => value.DOScale(value.localScale * bounceValue, duration)
                .SetUpdate(true)
                .SetLink(value.gameObject)
                .SetLoops(-1, LoopType.Yoyo);

        public static void ResetScaleTo1(this Transform value, float duration)
            => value.DOScale(1, duration)
                .SetUpdate(true)
                .SetLink(value.gameObject);
    }
}